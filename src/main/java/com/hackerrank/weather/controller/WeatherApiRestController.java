...
public class WeatherApiRestController {
    ...
    @ApiOperation(value = "Gets all of the temperatures with city name",
            notes = "Provide a city name to return a list of their temperatures",
            response = WeatherCityAndTempResponse.class,
